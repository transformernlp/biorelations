...
function get_rels() {
  ...
  if (res["caused by"].length > 0) {
    ...
    document.getElementById("cause_div").innerHTML =
      "<strong><u>Caused By </u></strong><li>" + cause_rels.join("</li><li>");
    +"</li>";
  }
  if (res["treated by"].length > 0) {
    var treat_rels = res["treated by"].slice(0, 10);
    document.getElementById("treat_div").innerHTML =
      "<strong><u>Treated By</u></strong><li>" + treat_rels.join("</li><li>");
    +"</li>";
  }
}
...
loadJSON(function (response) {
  ...
  entities_list = Object.keys(actual_JSON);
  console.log(entities_list);
  autocomplete(document.getElementById("query"), entities_list);
});
// console.log(entities_list);
// console.log("in");
